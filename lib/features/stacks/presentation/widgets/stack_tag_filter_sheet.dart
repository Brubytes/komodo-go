...
class StackTagOption {
  const StackTagOption({required this.id, required this.name});

  final String id;
  final String name;
}

class StackTagFilterSheet extends StatefulWidget {
  const StackTagFilterSheet({
  ...
  static Future<Set<String>?> show(
    ...
    return showModalBottomSheet<Set<String>>(
      ...
      builder: (context) => StackTagFilterSheet(
  ...
  @override
  State<StackTagFilterSheet> createState() => _StackTagFilterSheetState();
}

class _StackTagFilterSheetState extends State<StackTagFilterSheet> {
        ...
        children: [
          ListView(
            ...
            children: [
              ...
              const Gap(8),
              Text(
                'Select tags to filter stacks. Matching any tag will include a stack.',
