...
part 'procedures_filters_provider.g.dart';

@riverpod
class ProceduresSearchQuery extends _$ProceduresSearchQuery {
  @override
  String build() => '';
...
@riverpod
class ProceduresTagFilter extends _$ProceduresTagFilter {
  @override
...
@riverpod
class ProceduresTemplateFilterState extends _$ProceduresTemplateFilterState {
  @override
