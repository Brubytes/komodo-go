...
part 'syncs_filters_provider.g.dart';

@riverpod
class SyncsSearchQuery extends _$SyncsSearchQuery {
  @override
  String build() => '';
...
@riverpod
class SyncsTagFilter extends _$SyncsTagFilter {
  @override
...
@riverpod
class SyncsTemplateFilterState extends _$SyncsTemplateFilterState {
  @override
