...
part 'repos_filters_provider.g.dart';

@riverpod
class ReposSearchQuery extends _$ReposSearchQuery {
  @override
  String build() => '';
...
@riverpod
class ReposTagFilter extends _$ReposTagFilter {
  @override
...
@riverpod
class ReposTemplateFilterState extends _$ReposTemplateFilterState {
  @override
